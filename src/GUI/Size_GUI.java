 ...
 * @author DoHuy
 */
public class Size_GUI extends javax.swing.JFrame {

    DAO.Size_DAO da;
    ArrayList<DTO.Size_DTO> dssize;
    int vitri = 0;
...
//        dskh = da.LayDanhSachProc();
    ...
    private void HienThiTextBox(int vitri) {
        DTO.Size_DTO m = dssize.get(vitri);
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtTimSize, javax.swing.GroupLayout.PREFERRED_SIZE, 353, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        ...
        //        if (maSize.isEmpty()) {
            //            JOptionPane.showMessageDialog(null, "Mã size là thông tin bắt buộc, vui lòng nhập thông tin.");
    ...
    private DTO.Size_DTO chuyenDoi() {
        DTO.Size_DTO m = new DTO.Size_DTO();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Size_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
