...
public class KetNoiDB_GUI extends javax.swing.JFrame {
    ...
    private void but_DangNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_but_DangNhapActionPerformed
        ...
        connection.ConnectionDataBase(txt_SVName.getText(),txt_DBName.getText(),txt_UserName.getText(),txt_Pass.getText(),txt_Port.getText(),this);
    ...
    private void ketNoiGUI_open(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_ketNoiGUI_open
       try{
           FileInputStream fis=new FileInputStream("D:\\netbeans_work\\QL_BanGiay_08\\database\\conn_db.txt");
