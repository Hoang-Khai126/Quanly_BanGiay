...
public class DangNhap_GUI extends javax.swing.JFrame {
    ...
    private void xuLyDangNhap() {
        ...
        TaiKhoan_DTO tk = dangNhap_BUS.getTaiKhoanDangNhap(txtTenDN.getText(),
                String.valueOf(txt_MatKhau.getPassword()));
        if (tk != null) {
            this.dispose();
            GUI.MainGUI gui = new MainGUI();
            gui.showMainGUI();
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icon/tải xuống.jpg"))); // NOI18N
