...
public class Loai_GUI extends javax.swing.JFrame {
    ...
    public Loai_GUI() {
        initComponents();
        table_Loai.setDefaultEditor(Object.class, null);
        loadDataLenTableLoai();
    }

    private LoaiSP_BUS loaiBus = new LoaiSP_BUS();
    
    private void loadDataLenTableLoai() {
        loaiBus.docDanhSachLoai();
        ArrayList<LoaiSP_DTO> dsLoai = loaiBus.layDanhSachLoai();
        loadDataLenTableLoai(dsLoai);
    }

    private void loadDataLenTableLoai(ArrayList<LoaiSP_DTO> Loai) {
        String[] hearder = {"Mã loại", "Tên loại", "Trạng thái"};
        DefaultTableModel model = new DefaultTableModel(hearder, 0);
        for (LoaiSP_DTO m : Loai) {
            Object[] o = {m.getMaLoai(), m.getTenLoai(), m.getTrangThai()};
            model.addRow(o);
        }
        table_Loai.setModel(model);
    }   
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DANH SÁCH LOẠI");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Loại sản phẩm", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
        ...
        jLabel6.setText("* Mã loại sẽ được tự cập nhật");

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(null, "Danh sách Màu", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12)), "Danh sách loại", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
        ...
        jScrollPane1.setViewportView(table_Loai);
